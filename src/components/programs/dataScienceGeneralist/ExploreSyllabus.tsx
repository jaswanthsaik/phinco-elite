      ...
      <div className="mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-3 text-sm leading-6 text-slate-600 sm:text-base lg:text-lg">
            Our curriculum is designed to take you from the fundamentals of Data Science to building real-world AI and Generative AI applications. You won't just learn tools—you'll understand how to use them to solve practical business problems.
          </p>
        </div>
