...
export const Route = createFileRoute("/Internship_for_Full_Stack_Developers")({
  head: () => ({
    meta: [
      { title: "Internship for Full Stack Developers — Phinco Elite" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "Internship for Full Stack Developers — Phinco Elite" },
      {
...
function ProgramPage() {
  return (
    <div className="min-h-screen bg-background">
      <Header />
      <main>
        <ProgramHero titleTop="Internship" titleHighlight="for Full Stack Developers" />
        <AlumniCompanies />
        <LearningToPlacement />
        <SupportThatMatters />
        <WhyChooseLearnbay />
