...
export const Route = createFileRoute("/mastersDevelopers")({
  head: () => ({
    meta: [
      { title: "Masters for Developers — Phinco Elite" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "Masters for Developers — Phinco Elite" },
      {
...
function ProgramPage() {
  return (
    <div className="min-h-screen bg-background">
      <Header />
      <main>
        <ProgramHero titleTop="Masters" titleHighlight="for Developers" />
        <AlumniCompanies />
        <LearningToPlacement />
        <SupportThatMatters />
        <WhyChooseLearnbay />
